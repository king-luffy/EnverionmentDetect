...
/**
 * Created by king_luffy on 2017/8/11.
 */
public class ScreenCapture {
    // test main
    public static void main(String[] args) throws Exception {
        fullScreenCaptureTest();
    }
    private static void fullScreenCaptureTest() throws IOException {
        String userdir = System.getProperty("user.dir");
        File tempFile = new File(userdir, "temp.png");
        ScreenCapture capture = ScreenCapture.getInstance();
        BufferedImage image = capture.captureFullScreenImage();

        capture.saveAsPNG(image,tempFile);
        System.out.println("Over");
    }
    private static void screenCaptureTest() throws IOException {
        String userdir = System.getProperty("user.dir");
        File tempFile = new File(userdir, "temp.png");
        ScreenCapture capture = ScreenCapture.getInstance();
    ...
    public BufferedImage captureFullScreenImage(){
        fullScreenImage = robot.createScreenCapture(new Rectangle(Toolkit
                .getDefaultToolkit().getScreenSize()));
    ...
    public void saveAsPNG(BufferedImage image,File file) throws IOException {
        ImageIO.write(image,defaultImageFormater,file);
    }
